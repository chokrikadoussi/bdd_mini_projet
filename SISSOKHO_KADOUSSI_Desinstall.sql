SPOOL "C:\temp\pise\SISSOKHO_KADOUSSI_Drop_Tables.log"
...
ALTER TABLE DEMANDE DROP CONSTRAINT produit_fk;
...
ALTER TABLE CHANGEMENT_STATUT DROP CONSTRAINT changestatut_demande_fk;
